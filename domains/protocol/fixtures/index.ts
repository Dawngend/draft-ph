...
export const players: Player[] = [
  ...
  player({ id: "kyzen", handle: "kyzen", school: "De La Salle University", team: "DLSU Green Blades", rating: 84.1, rank: "Immortal 1", averageCombatScore: 231, winRate: 64, kda: 1.34, avatar: "linear-gradient(135deg, #3ddad7, #17706e)" }),
  player({ id: "reyna-exe", handle: "Reyna.exe", school: "Ateneo de Manila University", team: "ADMU Blue Eagles", rating: 89.2, rank: "Immortal 3", averageCombatScore: 258, winRate: 71, kda: 1.43, avatar: "linear-gradient(135deg, #ffa93d, #a86612)" }),
  player({ id: "nullframe", handle: "nullframe", school: "FEU Institute of Technology", team: "FEU Tech Tamaraws", rating: 82.8, rank: "Ascendant 3", verified: false, verifiedDomain: "", averageCombatScore: 227, winRate: 59, kda: 1.31, avatar: "linear-gradient(135deg, #6b7590, #333a4a)" }),
  player({ id: "mapua-jett", handle: "MapuaJett", school: "Mapúa University", team: "Mapua Cardinals", rating: 81.9, averageCombatScore: 221, winRate: 62, kda: 1.28, avatar: "linear-gradient(135deg, #e5484d, #8a2226)" }),
  player({ id: "sablay", handle: "sablay", school: "University of the Philippines", team: "UP Fighting Maroons", rating: 80.4, averageCombatScore: 215, winRate: 60, kda: 1.24, avatar: "linear-gradient(135deg, #333a4a, #1a1f2b)" }),
  player({ id: "ghostbyte", handle: "ghostbyte", school: "National University", team: "NU Bulldogs", rating: 79.6, averageCombatScore: 209, winRate: 58, kda: 1.19, avatar: "linear-gradient(135deg, #2c3446, #1a1f2b)" }),
  player({ id: "kalachuchi", handle: "kalachuchi", school: "University of Santo Tomas", team: "UST Tigers", rating: 78.8, averageCombatScore: 204, winRate: 57, kda: 1.16, avatar: "linear-gradient(135deg, #333a4a, #1a1f2b)" }),
  player({ id: "tabo", handle: "tabo.", school: "Ateneo de Manila University", team: "ADMU Blue Eagles", rating: 77.9, averageCombatScore: 198, winRate: 56, kda: 1.14, avatar: "linear-gradient(135deg, #333a4a, #1a1f2b)" }),
  player({ id: "rizal-rush", handle: "RIZALrush", school: "Polytechnic University of the Philippines", team: "PUP Radials", rating: 76.5, averageCombatScore: 194, winRate: 55, kda: 1.11, avatar: "linear-gradient(135deg, #2c3446, #1a1f2b)" }),
  player({ id: "himala", handle: "himala", school: "De La Salle University", team: "DLSU Green Blades", rating: 75.2, averageCombatScore: 189, winRate: 54, kda: 1.08, avatar: "linear-gradient(135deg, #333a4a, #1a1f2b)" }),
  player({ id: "batstate-frag", handle: "BatStateFrag", school: "Batangas State University", team: "Batangas State", rating: 74.1, averageCombatScore: 185, winRate: 53, kda: 1.05, avatar: "linear-gradient(135deg, #2c3446, #1a1f2b)" }),
];
...
export const scoutFixture: ScoutFixture = {
  ...
  rows: [
    ...
    { rank: 4, playerId: "nullframe", chemistry: 72, saved: false, rating: 79.6, averageCombatScore: 212, winRate: 59 },
    { rank: 5, playerId: "mapua-jett", chemistry: 69, saved: false, rating: 82.8, averageCombatScore: 227, winRate: 62 },
  ],
};
